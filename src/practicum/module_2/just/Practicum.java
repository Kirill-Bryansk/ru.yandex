...
class Student implements Comparable<Student> {
    ...
    public static void main(String[] args) {
        final Student a = new Student("aaa", 30);
        final Student b = new Student("aaa", 27);
        final Student c = new Student("ccc", 33);

        final Student d = new Student("ddd", 21);

        // создаём изменяемый список из неизменяемого List.of(..)
        final List<Student> list = new ArrayList<>(List.of(a, b, c, d));
